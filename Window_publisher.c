...
DDS_DataWriter *
Application_create_publisher_and_datawriter(
...
Application_create_subscriber_and_datareader(
    DDS_DomainParticipant *participant,
    DDS_Topic *topic,
    ...
    char **window_ids)
{
    ...
    _datawriter = Application_create_publisher_and_datawriter(participant, topic_window_update, &dw_qos);
    if (_datawriter == NULL)
    {
    ...
    datareader = Application_create_subscriber_and_datareader(participant, topic_window_command, &dr_qos, &command);
    if (datareader == NULL)
    {
