...
* -------------------------------------------------------------------------- */
RTI_BOOL 
window_id_t_cdr_serialize(
    struct CDR_Stream_t *stream, const void *void_sample, void *param)
{
    window_id_t *sample = (window_id_t *)void_sample;
...
RTI_UINT32
window_id_t_get_serialized_sample_max_size(
    ...
    void *param)
{
    ...
    current_alignment += CDR_get_max_size_serialized_string(
        current_alignment, ((ID_STR_LEN))+1);
...
* -------------------------------------------------------------------------- */
RTI_BOOL
window_id_t_cdr_serialize_key(
    struct CDR_Stream_t *stream, const void *void_sample, void *param)
{
    return window_id_t_cdr_serialize(stream, void_sample, param);
}

RTI_BOOL
window_id_t_cdr_deserialize_key(
    struct CDR_Stream_t *stream, void *void_sample, void *param)
{
    return window_id_t_cdr_deserialize(stream, void_sample, param);
}

RTI_UINT32
window_id_t_get_serialized_key_max_size(
    struct NDDS_Type_Plugin *plugin,
    RTI_UINT32 current_alignment,
    void *param)
{
    return window_id_t_get_serialized_sample_max_size(plugin, current_alignment, param);
}
